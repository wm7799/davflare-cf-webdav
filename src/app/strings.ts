...
const entries: Record<string, Entry> = {  searchPlaceholder: { zh: "搜索文件", en: "Search files" },
  ...
  flagWebdavHint: {
     zh: "关闭后客户端无法挂载 / 或 /webdav。网页端文件管理仍走会话接口。",
     en: "Off: clients cannot mount / or /webdav. The web file manager still uses the session APIs.",
  },
  ...
  mcpPlayGuideTitle: { zh: "AI 连上后能读到什么", en: "What an AI reads once connected" },
  mcpPlayGuideHint: {
    zh: "initialize 会下发一段中文使用说明（MCP instructions），客户端会自动注入模型上下文。所以别人接上这个 MCP 就能看懂怎么操作，不需要先读文档。",
    en: "initialize ships a Chinese usage brief (MCP instructions) that clients inject into model context — anyone connecting understands how to operate without reading docs first.",
  },
  mcpPlayGuideAction: { zh: "复制给 AI 的说明", en: "Copy the AI brief" },
  mcpPlayGuideCopied: { zh: "说明已复制", en: "Brief copied" },
  mcpPlayGuideFetch: { zh: "拉取实际说明", en: "Fetch live instructions" },
  mcpPlayGuideFetchFailed: { zh: "拉取说明失败", en: "Failed to fetch instructions" },
  mcpPlayToolCount: { zh: "25 个工具，均带中文名与只读/破坏性标记", en: "25 tools, all with Chinese titles and read-only/destructive hints" },
  mcpPlayInfo: {
